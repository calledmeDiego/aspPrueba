...
namespace SustentacionASPNETCoreMVC.Migrations
{
    ...
    [Migration("20231031042132_DBINITCONTEXTV5")]
    partial class DBINITCONTEXTV5
    {
            ...
            modelBuilder.Entity("SustentacionASPNETCoreMVC.Models.Tramites.TramiteModel", b =>
                {
                    ...
                    b.Property<int?>("UsuarioIdPerson")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SustentacionASPNETCoreMVC.Models.Tramites.TramiteModel", b =>
                {
                    ...
                    b.HasOne("SustentacionASPNETCoreMVC.Models.Persona", "OUsuario")
                        .WithMany()
                        .HasForeignKey("IdUsuario");

                    b.HasOne("SustentacionASPNETCoreMVC.Models.Usuario", null)
                        .WithMany("Tramites")
                        .HasForeignKey("UsuarioIdPerson");
